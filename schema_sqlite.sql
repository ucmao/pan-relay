...
('qkpanso', 'https://qkpanso.com/v1/search/disk', 'post', '{"page": 1, "q": "[[keyword]]", "user": "", "exact": false, "format": [], "share_time": "", "size": 15, "type": "", "exclude_user": [], "adv_params": {"wechat_pwd": "", "platform": "pc"}}', 'data.list[*].[disk_name, link]', 1, 2412, 1),
('uuxiao', 'https://uuxiao.cn/api/user/search?name=[[keyword]]', 'get', '', 'data[*].[name, url]', 1, 378, 1),
('hhlqilongzhu', 'https://www.hhlqilongzhu.cn/api/ziyuan_nanfeng.php?keysearch=[[keyword]]', 'get', '', 'data[*].[title, data_url]', 1, 193, 1),
...
('110t', 'https://ys.110t.cn/api/ajax.php?act=search&name=[[keyword]]', 'get', '', 'data[*].[name, url]', 1, 21, 1),
('ycubbs', 'https://ai-img.ycubbs.cn/api/duanju/search?name=[[keyword]]', 'get', '', 'data[*].[name, url]', 1, 651, 1),
('qsdurl', 'https://api.qsdurl.cn/tool/duanju?name=[[keyword]]', 'get', '', '[*].[name, url]', 1, 5010, 1),
('mywl', 'https://cx.mywl.top/api/duanju/search?keyword=[[keyword]]', 'get', '', 'data[*].[title, url]', 1, 124, 1),
('kuleu', 'https://api.kuleu.com/api/action?text=[[keyword]]', 'get', '', 'data[*].[name, viewlink]', 1, 345, 1),
('kuoapp', 'https://kuoapp.com/duanju/api.php?param=1&name=[[keyword]]', 'get', '', 'data[*].[name, url]', 1, 5117, 1),
