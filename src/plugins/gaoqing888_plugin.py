...
class Gaoqing888Plugin(BasePlugin):
    name = "gaoqing888"
    display_name = "888高清影视"
    version = "1.0.0"
    author = "pan-relay"
    description = "888高清影视 数据源搜索插件"
    priority = 140
    is_enabled = True
    timeout = 5.0
    ...
    def search(self, keyword: str) -> List[SearchResultItem]:
        ...
        if not keyword:
            return results
        url = "https://www.gaoqing888.com/search?q=%s" % keyword
        headers = {"User-Agent": user_agents[0], "Referer": "https://www.gaoqing888.com"}
        try:
    ...
    def health_check(self) -> Tuple[bool, str]:
        try:
            r = requests.get("https://www.gaoqing888.com", headers={"User-Agent": user_agents[0]}, timeout=3.0)
