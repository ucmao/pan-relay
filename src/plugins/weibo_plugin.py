...
class WeiboPlugin(BasePlugin):
    ...
    def search(self, keyword: str) -> List[SearchResultItem]:
        ...
        headers = {"User-Agent": user_agents[0], "Referer": "https://s.weibo.com"}
        try:
    ...
    def health_check(self) -> Tuple[bool, str]:
        try:
            r = requests.get("https://s.weibo.com", headers={"User-Agent": user_agents[0]}, timeout=3.0)
