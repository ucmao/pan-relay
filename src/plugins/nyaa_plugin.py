...
class NyaaPlugin(BasePlugin):
    ...
    def search(self, keyword: str) -> List[SearchResultItem]:
        ...
        if not keyword:
            return results
        url = "https://nyaa.si/?f=0&c=0_0&q=%s" % keyword
        headers = {"User-Agent": user_agents[0], "Referer": "https://nyaa.si"}
        try:
    ...
    def health_check(self) -> Tuple[bool, str]:
        try:
            r = requests.get("https://nyaa.si", headers={"User-Agent": user_agents[0]}, timeout=3.0)
