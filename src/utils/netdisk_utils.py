...
CANONICAL_ID_PATTERNS = [
    ...
    ("123pan", re.compile(r"(?:123pan\.com|123\d{3}\.(?:com|cn))/s/([a-zA-Z0-9_-]+)", re.IGNORECASE)),
    ...
    ("mobile", re.compile(r"(?:yun\.139\.com/shareweb/#/w/i/|caiyun\.139\.com/w/i/|caiyun\.139\.com/m/i\?|pan\.10086\.cn/s/)([a-zA-Z0-9_-]+)", re.IGNORECASE)),
    ("pikpak", re.compile(r"pikpak\.com/s/([a-zA-Z0-9_-]+)", re.IGNORECASE)),
